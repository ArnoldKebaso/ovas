    ...
    <div class="row g-4">
      ...
      <div class="col-lg-2 col-md-6">
        ...
        <ul class="list-unstyled">
          ...
          <li class="mb-2"><a href="./?page=home#about" class="text-white-50 text-decoration-none hover-primary"><i class="fas fa-chevron-right me-2 small"></i>About Us</a></li>
          <li class="mb-2"><a href="./?page=home#contact" class="text-white-50 text-decoration-none hover-primary"><i class="fas fa-chevron-right me-2 small"></i>Contact</a></li>
        </ul>
      </div>
